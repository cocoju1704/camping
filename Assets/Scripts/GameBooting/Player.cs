...
public class Player : Singleton<Player>
{
    ...
    public void SetPlayerSpec(List<FurnitureIdLvPos> furnitureIdLvPos) {
        foreach (var idLvPos in furnitureIdLvPos) {
            ...
            switch (idLvPos.id) {
                ...
                case 2: // Gym
                    break;
                case 3: // TreadMill
                    maxStamina = data.levelNums[level];
                    break;
                case 4: // Crate
                    //carSpec.maxStorage = (int)data.levelNums[level];
                    break;
                case 5: // Shooting Range
                    reloadMultiplier = data.levelNums[level] / 100f;
                    break;
                case 6: //
                    maxHealth = (int)data.levelNums[level];
                    break;
                default:
                    break;
            }
            OnPlayerSpecChanged.Invoke();
        }                    
    }
}
